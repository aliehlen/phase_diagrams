...
function define_params(tables){
	params = new function() {
        ...
        this.colormap = d3.scaleOrdinal(["SC", "SH", "BCC", "FCC", "BCT", "compr. BCC", "BCC/FCC coex.", "A20", "melted", "jammed"],
                                        ["#d13917", "#efc000", "#0094f7", "#00c95e", "#221973", "#82a6b1", "#007387", "#c779b2", "#d6d6d6", "#6e6e6e"]);
        this.legendcolors = [];
	};
}
